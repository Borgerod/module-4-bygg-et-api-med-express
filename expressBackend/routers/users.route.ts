...
import {
  createUser,
  getUsers,
} from "@expressBackend/controllers/users.controllers";
import { UserRegistration, UserType } from "@expressBackend/schema/user.schema";

export type QueryParam = UserType[keyof UserType];
